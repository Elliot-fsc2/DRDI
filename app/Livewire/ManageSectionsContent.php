...
class ManageSectionsContent extends Component implements HasActions, HasSchemas
{
    ...
    public function createAction(): Action
    {
        return Action::make('create')
            ...
            ->modalSubheading('Add a new section for the current academic year.')
            ->form([
                TextInput::make('name')
                    ->label('Section Name')
                    ->required()
    ...
    {
        return view('livewire.manage-sections-content', [
